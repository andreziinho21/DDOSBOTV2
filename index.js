...
//
setTitle("[" + soma4 +"] Atom | Coded By: André " + Autor);
bot.on("ready", () => {

    console.log('')
    console.log(white + `░█████╗░████████╗░█████╗░███╗░░░███╗` + reset + supered + `┌─────────────────────┐` + purple + ` ⇱`)
    console.log(white + `██╔══██╗╚══██╔══╝██╔══██╗████╗░████║` + reset + supered + `│  ` + reset + `Seja bem vindo a   ` + supered + `│`)
    console.log(white + `███████║░░░██║░░░██║░░██║██╔████╔██║` + reset + supered + `│  ` + reset + lightred + `AtomV1` + reset + lightgreen + ` V1   ` + supered + `│` + green + ` 愛`)
    console.log(red +   `██╔══██║░░░██║░░░██║░░██║██║╚██╔╝██║` + reset + supered + `├─────────────────────┤` + purple + ` す`)
    console.log(red +   `██║░░██║░░░██║░░░╚█████╔╝██║░╚═╝░██║` + reset + supered + `│ ` + reset + `Twitter: ` + lightgreen + `andre#0001` + supered + ` │ ` + green + `る` + reset + supered)
    console.log(red +   `╚═╝░░╚═╝░░░╚═╝░░░░╚════╝░╚═╝░░░░░╚═╝` + reset + supered + `├────────────┬┬───────┤` + reset + supered)
    console.log(bgRed + ` All Rights Reserved ₪ AtomV1 2020 ` + reset + supered + `│ ` + reset + `Servers: ` + lightgreen + `↑ ` + supered + `├┤ ` + reset + `L4:` + lightgreen + `🅰  ` + supered + `│` + purple + ` 平` + reset + supered)
    console.log(supered + `╔════════════════════╦════╦══════════════════╗` + supered + `├──────────┬─┘├───────` + green + reset + supered + `┤` + green + ` 和`)
    console.log(supered + `║ ` + reset + swhite + ` Terminal of Logs ` + supered + ` ║ ` + reset + yellow + `◄►` + supered + ` ║ ` + reset + swhite + `AtomV1 ` + lightgreen + `V1` + supered + ` ║` + supered + `│ ` + reset + `API's:` + lightgreen + ` ↑` + supered + ` │  │ ` + reset + `L7:` + lightgreen + `🅱  ` + reset + supered + `│`)
...
if (command === 'help') {
  ...
  const response = new Discord.RichEmbed()
    .setColor("#8b1e9b")
    .setAuthor(`Bem vindo ao atom.`,"","https://t.me/demonv2")
    .setTitle("Atom | Help Menu ")
...
if (command === 'buy') {
  ...
  const privbuyembed = new Discord.RichEmbed()
    .setImage("https://cdn.discordapp.com/attachments/775792003995795507/778747156517224517/Foto_conta_steam.jpg")
    .setColor('#ff0000')
    .setTitle('Atom - Compra')
    .setThumbnail('https://cdn.discordapp.com/attachments/775792003995795507/778747156517224517/Foto_conta_steam.jpg')
    ...
    .addField("```PREÇO```", "```http\n5,00 €\n10,00 €\n15,00 €\n20,00 €\n30,00 €\n```", true)
    .addField("```MÉTODOS```", "**__PAYPAL__ Only!**")
  msg.author.send(privbuyembed)
//
  let buyreply = await msg.reply('Mandei-te uma `mensagem no privado` com todas as informações, esta mensagem vai ser removida em 10 segundos.')
...
const methodsem = new Discord.RichEmbed()
  ...
  .addField("**Layer 4 TCP**", "```http\nTELNET\nTCP_VOX\nTCP_XMAS```", true)        
  .setTimestamp()
  .setFooter("Atom | V1.", "https://cdn.discordapp.com/attachments/775792003995795507/778747156517224517/Foto_conta_steam.jpg");
...
const metodoembed = new Discord.RichEmbed()
  .setColor("#ff0000")
  .setTitle("Database Editor -> AtomV1")
...
if (args < 1) {
  const response = new Discord.RichEmbed()
    ...
    .setTimestamp()
    .setFooter(`${msg.author.username} - AtomV1.`, `${msg.author.displayAvatarURL}`);
...
//
   response = new Discord.RichEmbed()
    .setColor("#249c2b")
    .setTitle("Atom Host Loockup Tool")
...
// IMPORTANT: THIS DATA (in up line) DONT WORK IN WEBSITES!!!!!
    ...
    const embed2 = new Discord.RichEmbed()
      .setAuthor(`A new attack was sent..`,"https://cdn.discordapp.com/attachments/775792003995795507/778747156517224517/Foto_conta_steam.jpg","www.atom.com")
      .setTitle("```[🔥] Atom V1 - Attack [🔥]```")
      .setColor("#8b1e9b")
      .setThumbnail("https://cdn.discordapp.com/attachments/775792003995795507/778747156517224517/Foto_conta_steam.jpg7")
